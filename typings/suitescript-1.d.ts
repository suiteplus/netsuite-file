...
declare function nlapiLoadRecord(type: string, id: number, initializeValues? : any): nlobjRecord;
...
declare function nlapiSearchRecord(type : string, searchid? : string, srchFilters? : any, columns? : nlobjSearchColumn[]): nlobjSearchResult[];
declare function nlapiCreateSearch(type : string, srchFilters? : any, columns? : nlobjSearchColumn[]): nlobjSearch;
...
declare function nlapiLookupField(type :string , id :string|number , fields :string[], text?: boolean): any;
declare function nlapiLookupField(type :string , id :string|number , field :string, text?: boolean): string;
...
declare function nlapiResolveURL(type :string, subtype : string, id? : string, pagemode? : any): string;
...
declare function nlapiCreateError(code : string|number, details :string, suppressEmail? : boolean): nlobjError;
...
declare function nlapiSelectNodes(node:Node, path : string): any[];
...
declare function nlapiValidateXML(xmlDocument : Node, schemaDocument : Node , schemaFolderId? : number) : void;
